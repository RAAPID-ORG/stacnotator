"""add_is_authoritative_to_annotations

Revision ID: d7d4be498013
Revises: f5283844a784
Create Date: 2026-02-01 13:21:49.542383
...
revision: str = 'd7d4be498013'# revision identifiers, used by Alembic.

down_revision: Union[str, Sequence[str], None] = 'f5283844a784'revision: str = 'd7d4be498013'

branch_labels: Union[str, Sequence[str], None] = Nonedown_revision: Union[str, Sequence[str], None] = 'f5283844a784'

depends_on: Union[str, Sequence[str], None] = Nonebranch_labels: Union[str, Sequence[str], None] = None
...
def upgrade() -> None:
    ...
    # Add is_authoritative column to annotations table    """Upgrade schema."""

    op.add_column(    # ### commands auto generated by Alembic - please adjust! ###

        'annotations',    op.drop_table('bg', schema='tiger')

        sa.Column('is_authoritative', sa.Boolean(), nullable=False, server_default=sa.false()),    op.drop_table('pagc_rules')

        schema='data'    op.drop_table('zcta5')
...
def downgrade() -> None:    op.drop_table('zip_lookup_all')

    """Downgrade schema."""    op.drop_index(op.f('tiger_place_the_geom_gist'), table_name='place', schema='tiger', postgresql_using='gist')

    # Remove is_authoritative column from annotations table    op.drop_table('place', schema='tiger')

    op.drop_column('annotations', 'is_authoritative', schema='data')    op.drop_table('tract')

    op.drop_table('pagc_lex', schema='tiger')
    ...
    op.drop_index(op.f('countysub_lookup_name_idx'), table_name='countysub_lookup', schema='tiger')
    op.drop_index(op.f('countysub_lookup_state_idx'), table_name='countysub_lookup', schema='tiger')
    op.drop_table('countysub_lookup', schema='tiger')
    op.drop_table('zip_state_loc')
    op.drop_table('state_lookup', schema='tiger')
    ...
    op.drop_table('edges')
    op.drop_table('tabblock20', schema='tiger')
    ...
    op.drop_table('geocode_settings', schema='tiger')
    op.drop_table('zip_state', schema='tiger')
    op.drop_table('tabblock')
    op.drop_table('loader_variables')
    op.drop_index(op.f('county_lookup_name_idx'), table_name='county_lookup', schema='tiger')
    op.drop_index(op.f('county_lookup_state_idx'), table_name='county_lookup', schema='tiger')
    op.drop_table('county_lookup', schema='tiger')
    ...
    op.drop_table('faces')
    op.drop_table('pagc_rules', schema='tiger')
    op.drop_table('zcta5', schema='tiger')
    op.drop_table('geocode_settings_default', schema='tiger')
    op.drop_index(op.f('tige_cousub_the_geom_gist'), table_name='cousub', schema='tiger', postgresql_using='gist')
    op.drop_table('cousub', schema='tiger')
    op.drop_index(op.f('idx_tiger_addr_tlid_statefp'), table_name='addr', schema='tiger')
    op.drop_index(op.f('idx_tiger_addr_zip'), table_name='addr', schema='tiger')
    op.drop_table('addr', schema='tiger')
    op.drop_table('zip_lookup_all', schema='tiger')
    ...
    op.drop_table('tract', schema='tiger')
    op.drop_table('layer', schema='topology')
    ...
    op.drop_index(op.f('direction_lookup_abbrev_idx'), table_name='direction_lookup', schema='tiger')
    op.drop_table('direction_lookup', schema='tiger')
    op.drop_table('loader_lookuptables', schema='tiger')
    op.drop_table('zip_lookup_base', schema='tiger')
    op.drop_index(op.f('idx_tiger_county'), table_name='county', schema='tiger')
    op.drop_table('county', schema='tiger')
    op.drop_index(op.f('idx_tiger_addr_tlid_statefp'), table_name='addr')
    op.drop_index(op.f('idx_tiger_addr_zip'), table_name='addr')
    op.drop_table('addr')
    op.drop_index(op.f('idx_tiger_state_the_geom_gist'), table_name='state', schema='tiger', postgresql_using='gist')
    op.drop_table('state', schema='tiger')
    op.drop_index(op.f('street_type_lookup_abbrev_idx'), table_name='street_type_lookup', schema='tiger')
    op.drop_table('street_type_lookup', schema='tiger')
    op.drop_table('zip_state_loc', schema='tiger')
    op.drop_index(op.f('idx_edges_tlid'), table_name='edges', schema='tiger')
    op.drop_index(op.f('idx_tiger_edges_countyfp'), table_name='edges', schema='tiger')
    op.drop_index(op.f('idx_tiger_edges_the_geom_gist'), table_name='edges', schema='tiger', postgresql_using='gist')
    op.drop_table('edges', schema='tiger')
    op.drop_table('pagc_gaz')
    op.drop_index(op.f('secondary_unit_lookup_abbrev_idx'), table_name='secondary_unit_lookup', schema='tiger')
    op.drop_table('secondary_unit_lookup', schema='tiger')
    op.drop_index(op.f('idx_tiger_featnames_lname'), table_name='featnames', schema='tiger')
    op.drop_index(op.f('idx_tiger_featnames_snd_name'), table_name='featnames', schema='tiger')
    op.drop_index(op.f('idx_tiger_featnames_tlid_statefp'), table_name='featnames', schema='tiger')
    op.drop_table('featnames', schema='tiger')
    op.drop_table('bg')
    op.drop_table('zip_lookup', schema='tiger')
    op.drop_table('layer')
    op.drop_table('topology')
    op.drop_table('tabblock', schema='tiger')
    op.drop_table('loader_variables', schema='tiger')
    op.drop_index(op.f('idx_addrfeat_geom_gist'), table_name='addrfeat', schema='tiger', postgresql_using='gist')
    op.drop_index(op.f('idx_addrfeat_tlid'), table_name='addrfeat', schema='tiger')
    op.drop_index(op.f('idx_addrfeat_zipl'), table_name='addrfeat', schema='tiger')
    op.drop_index(op.f('idx_addrfeat_zipr'), table_name='addrfeat', schema='tiger')
    op.drop_table('addrfeat', schema='tiger')
    op.drop_index(op.f('tiger_place_the_geom_gist'), table_name='place', postgresql_using='gist')
    op.drop_table('place')
    op.drop_index(op.f('idx_tiger_faces_countyfp'), table_name='faces', schema='tiger')
    op.drop_index(op.f('idx_tiger_faces_tfid'), table_name='faces', schema='tiger')
    op.drop_index(op.f('tiger_faces_the_geom_gist'), table_name='faces', schema='tiger', postgresql_using='gist')
    op.drop_table('faces', schema='tiger')
    op.drop_table('pagc_lex')
    op.drop_table('loader_platform', schema='tiger')
    op.drop_index(op.f('place_lookup_name_idx'), table_name='place_lookup', schema='tiger')
    op.drop_index(op.f('place_lookup_state_idx'), table_name='place_lookup', schema='tiger')
    op.drop_table('place_lookup', schema='tiger')
    ...
    op.drop_table('pagc_gaz', schema='tiger')
...
def downgrade() -> None:
    ...
    op.create_table('topology',
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"topology".topology_id_seq\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('srid', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('precision', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('hasz', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False, nullable=False),
