...
import type { ExtendedLabel, GeometryType } from './OpenModeControls';
import { extendLabelsWithMetadata } from './OpenModeControls';
  ...
  useEffect(() => {
    ...
    if (lastPanTriggerRef.current !== panTrigger.count) {
      ...
      switch (panTrigger.direction) {
        case 'up': y = -MAP_ANIMATION.PAN_OFFSET_PIXELS; break;
        case 'down': y = MAP_ANIMATION.PAN_OFFSET_PIXELS; break;
        case 'left': x = -MAP_ANIMATION.PAN_OFFSET_PIXELS; break;
        case 'right': x = MAP_ANIMATION.PAN_OFFSET_PIXELS; break;
      }
          ...
          if (savedAnnotation) {
            ...
            setTimeout(() => {
              if (drawnItemsRef.current) {
                ...
                const newLayer = layers.find((l: any) => l._annotationId === savedAnnotation.id) as any;
  ...
  return (
    <>
      <div ref={containerRef} className="w-full h-full relative">
        ...
        {selectedLayerId && isEditing && activeTool === 'edit' && (() => {
