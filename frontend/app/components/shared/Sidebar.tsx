    ...
    >
      ...
      <nav className="flex flex-col flex-1 py-2 px-2 gap-1">
        <button
          ...
          title="Home"
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" className={`shrink-0 ${isHomeActive ? 'text-brand-500 stroke-current stroke-[1.5]' : ''}`}>
            {' '}
        ...
        <button
          ...
          title="Campaigns"
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" className={`shrink-0 ${isCampaignsActive ? 'text-brand-500 stroke-current stroke-[1.5]' : ''}`}>
            {' '}
        ...
        >
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <div className="text-sm text-neutral-900 cursor-pointer hover:text-brand-500" onClick={() => handleNavClick('/settings')}
>Settings</div>
              <LogoutButton />
            </div>
          )}
