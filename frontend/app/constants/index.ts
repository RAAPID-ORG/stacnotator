...
export const INITIALIZING_TEXT = 'Initializing...';

// Error messages
export const ERROR_MESSAGES = {
  CAMPAIGN_LOAD_FAILED: 'Failed to load campaign',
  CAMPAIGN_CREATE_FAILED: 'Failed to create campaign',
  ANNOTATION_SUBMIT_FAILED: 'Failed to submit annotation',
  LABEL_REQUIRED: 'Please select a label before submitting',
...
export const SUCCESS_MESSAGES = {
  ...
  ANNOTATION_SUBMITTED: 'Annotation submitted successfully',
