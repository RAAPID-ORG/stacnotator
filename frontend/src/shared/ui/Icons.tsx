...
export const IconWindow = ({ className = 'w-4 h-4' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M3.5 2A1.5 1.5 0 0 0 2 3.5v13A1.5 1.5 0 0 0 3.5 18h13a1.5 1.5 0 0 0 1.5-1.5v-13A1.5 1.5 0 0 0 16.5 2h-13ZM3.5 3.5h13v3h-13v-3Zm0 4.5h6v8.5h-6V8Zm7.5 0h5.5v8.5H11V8Z" clipRule="evenodd" />
  </svg>
);
