 ...
 */
export const getAnnotationNavigation = <ThrowOnError extends boolean = false>(options: Options<GetAnnotationNavigationData, ThrowOnError>) => (options.client ?? client).get<GetAnnotationNavigationResponses, GetAnnotationNavigationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
