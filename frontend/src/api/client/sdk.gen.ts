 ...
 * Next Agent Tasks
 */
export const nextAgentTasks = <ThrowOnError extends boolean = false>(options: Options<NextAgentTasksData, ThrowOnError>) => (options.client ?? client).post<NextAgentTasksResponses, NextAgentTasksErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
