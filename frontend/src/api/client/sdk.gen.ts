 ...
 * call each.
 */
export const previewPlanetScenes = <ThrowOnError extends boolean = false>(options: Options<PreviewPlanetScenesData, ThrowOnError>) => (options.client ?? client).post<PreviewPlanetScenesResponses, PreviewPlanetScenesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
