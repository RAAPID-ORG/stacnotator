...
/** Keeps keyboard navigation legible inside scrollable panels. The focus call
 *  suppresses its own browser scroll so it cannot undo the centred reveal. */
...
function NumberField({
  ...
  // never conflicts with a digit prefix.
