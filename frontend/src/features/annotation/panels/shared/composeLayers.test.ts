...
const VIEW: ImageryViewOut = CAMPAIGN.imagery_views[0];

function ctxFor(mode: 'tasks' | 'explore'): ComposeCtx {
  return { campaign: CAMPAIGN, catalog: CATALOG, view: VIEW, mode, isMobile: false };
}
