...
import type { TimeseriesWindow } from '~/features/annotation/core/catalog';
import { Spinner } from '~/shared/ui/Spinner';
import type { LonLat } from '~/features/annotation/engine/map';
import type { ComposeCtx } from '../../composition';
import { useInteractionSpec } from '../../shared/interactionSpec';
import { useMapFocus } from '../../shared/mapFocus';
import { Chart } from './Chart';
import { timeSeriesCache, type LatLon, type TimeSeriesData } from './lib/cache';
...
export function TimeseriesPanel({ ctx, window: tsWindow }: TimeseriesPanelProps) {
  ...
  const probePoint = useInteractionSpec((s) => s.probePoint);
