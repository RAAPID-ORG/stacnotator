...
describe('nextFreeSlot', () => {
  ...
  it('ignores gaps left by earlier, non-bottom rows (fragmented layout)', () => {
    ...
    expect(nextFreeSlot(layout, 10)).toEqual({ x: 10, y: 10 });
  });
});
