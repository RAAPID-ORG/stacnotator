  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 border border-neutral-200"
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-neutral-600 space-y-3">
                    <p>
                      ...
                      the campaign <strong className="text-neutral-900">"{campaignName}"</strong>{' '}
                    ...
                    <p className="pt-2">
                      Please type{' '}
                      <strong className="font-mono text-neutral-900">{campaignName}</strong> to
                      confirm:
                    </p>
                  </div>
                  <div className="mt-3">
