      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="space-y-0.5">
          ...
          <input
            ...
            className="w-full border-brand-600 border-b focus:border-b-2 outline-none focus:ring-0 text-xs font-mono"
          />
        </div>
        <div className="space-y-0.5">
        ...
        {showCompositing && (
          <div className="space-y-0.5">
            ...
            <select
              ...
              className="w-full border-brand-600 border-b focus:border-b-2 outline-none focus:ring-0 text-xs bg-transparent"
            >
