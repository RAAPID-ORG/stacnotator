...
that imagery or annotations are accurate or cannot be compromised, or that data
will not be lost or corrupted. Imagery comes from third-party providers whose
availability, accuracy, and terms are outside our control. Verify results
...
Continuing to use the Service means you accept them.
