...
export const StepTarget = ({ plan, update }: Props) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        <SubHeading title="Target precision">
          How much uncertainty you are willing to publish alongside the number.
        </SubHeading>
        ...
        >
          Precision is stated as a percentage <em>of the number itself</em>. At 5%, an estimate of
          1.00 Mha comes with a 95% confidence interval of roughly ±0.10 Mha. Tighter targets cost
          points steeply: halving the interval needs about four times the sample.
        </Explain>
