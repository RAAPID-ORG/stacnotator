...
- `chrome/` — page-level UI about the *work* rather than the workspace: `Toolbar/`, `Tour/`, plus single-file surfaces (`MobileSliceNav`, `EditOverlayControls`, `Gates`).
